  ...
  function render() {
    ...
    host.outerHTML =
      '<header class="site-header"><div class="wrap header-inner">' +
        '<a class="brand" href="index.php" data-href-lang aria-label="SF TAX USA">' +
          '<img class="brand__logo" src="assets/sf-logo-full.png" alt="SF TAX USA — Santiago & Felix Accounting Services" />' +
        '</a>' +
        '<nav class="nav" aria-label="Primary">' +
          '<a href="index.php" data-href-lang data-i18n="nav.home"></a>' +
          '<a href="sobre.php" data-href-lang data-i18n="nav.about"></a>' +
          ...
          '<a href="contato.php" data-href-lang data-i18n="nav.contact"></a>' +
        '</nav>' +
      ...
      '<aside class="drawer" id="sf-drawer" aria-label="Menu" aria-hidden="true">' +
        ...
        '<nav class="drawer-nav" aria-label="Mobile">' +
          '<a href="index.php" data-href-lang data-i18n="nav.home" data-drawer-link></a>' +
          '<a href="sobre.php" data-href-lang data-i18n="nav.about" data-drawer-link></a>' +
          '<div class="drawer-acc">' +
            ...
            '<div class="drawer-acc__panel" data-acc-panel>' +
              '<a href="servicos.php" data-href-lang class="drawer-acc__all" data-drawer-link>' +
                '<span data-i18n="nav.allServices"></span>' + i("arrowR") +
              '</a>' +
              '<div class="drawer-acc__list" data-drawer-services></div>' +
            '</div>' +
          '</div>' +
          '<a href="contato.php" data-href-lang data-i18n="nav.contact" data-drawer-link></a>' +
        '</nav>' +
