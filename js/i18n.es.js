...
window.I18N.es = {
  ...
  cta: {
    ...
    svcCardWaMsg: "¡Hola! Me interesa el servicio de {{name}}. ¿Pueden contarme más?",
    svcCardCta: "Me interesa este servicio"
  },
  hero: {
    eyebrow: "Oficina en Orlando · Atención en todo EE.UU.",
    titleA: "Tu contador en Orlando — ",
    titleAccent: "para brasileños, latinos y empresas",
    titleB: " en todo EE.UU.",
    sub: "Con oficina en Orlando y clientes en todos los estados, SF TAX USA ha ayudado a cientos de inmigrantes a organizar su vida fiscal en EE.UU. Habla con nosotros hoy.",
    microcopy: "✓ Respuesta en menos de 2 horas  ·  ✓ Sin compromiso  ·  ✓ Atendemos en todo EE.UU.",
    ctaWhatsapp: "Hablar con un especialista ahora",
    trust1: "Orlando, FL — Oficina física",
    trust2: "Atendemos todo EE. UU.",
    trust3: "Especialistas en brasileños y extranjeros",
    trust4: "Respuesta en menos de 24h",
    trust5: "Atención en PT, EN y ES",
  ...
  coverage: {
    title: "Estamos en Orlando. Atendemos en todo EE.UU.",
    body: "Nuestra oficina está en Orlando, FL — pero nuestros clientes están en Miami, Nueva York, Atlanta, Houston, Boston, Los Ángeles y más de 30 estados. Donde estés, SF TAX USA está contigo.",
    cta: "Hablar con un especialista →",
    waMsg: "¡Hola! Vivo fuera de Florida y me gustaría saber si pueden atenderme."
  },
  why: {
  ...
  footer: {
    ...
    /* TODO: dirección placeholder — el cliente debe confirmar la dirección real */
    addrLine: "📍 6965 Piazza Gde Ave, Suite 309, Orlando, FL 33835",
    coverageLine: "Orlando, FL — Atendemos clientes en todo EE.UU.",
    hoursLine: "Lun–Vie, 9:00 a 18:00 (EST)",
    remoteText: "Atención remota para todo EE. UU.",
    waMsg: "¡Hola! Me gustaría saber más sobre los servicios de SF TAX USA.",
  ...
  servicesPage: {
    title: "Servicios",
    eyebrow: "Qué hacemos",
    h1: "Servicios de contabilidad e impuestos — Orlando y todo EE.UU.",
  ...
  testimonials: {
    ...
    ctaText: "Únete a nuestros clientes",
    ctaWaMsg: "¡Hola! Leí los testimonios en el sitio web y me gustaría conocer los servicios de SF TAX USA."
  }
};
