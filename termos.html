...
<title>SF TAX USA — Termos de Uso</title>
...
<section class="section" style="border-bottom:1px solid var(--line)">
  <div class="wrap">
    <nav class="breadcrumb reveal in" style="margin-bottom:18px">
      ...
      <span data-i18n="pages.terms.h1">Termos de Uso</span>
    </nav>
    <span class="eyebrow" data-i18n="pages.terms.eyebrow">Institucional</span>
    <h1 class="h-1" data-i18n="pages.terms.h1">Termos de Uso</h1>
    <p class="legal-meta" style="margin-top:14px" data-i18n="pages.legal.updated">Última atualização: junho de 2026</p>
  </div>
</section>

<section class="section">
  <div class="wrap legal-wrap" data-legal="terms"></div>
