...
<title>SF TAX USA — Serviços</title>
...
<section class="hero">
  <div class="wrap">
    <div style="max-width:760px;padding-block:clamp(48px,7vw,88px)">
      ...
      <span class="eyebrow" style="color:var(--blue)"><span data-i18n="servicesPage.eyebrow">O que fazemos</span></span>
      <h1 class="h-display" data-i18n="servicesPage.h1">Serviços de contabilidade e impostos na Flórida</h1>
      <p class="lead" style="margin-top:18px" data-i18n="servicesPage.sub">Soluções completas para pessoas físicas, empresas, brasileiros e estrangeiros nos EUA.</p>
      <div class="hero-cta">
        <a class="btn btn--green btn--lg" data-wa data-loc="services_hero"><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style="width:18px;height:18px"><path d="M19.05 4.91A9.82 9.82 0 0 0 12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.45 1.32 4.95L2 22l5.25-1.38a9.9 9.9 0 0 0 4.79 1.22h.004c5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.02z"/></svg><span data-i18n="cta.specialist">Fale com um especialista</span></a>
      </div>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="wrap">
    <div class="grid reveal" data-service-grid style="grid-template-columns:repeat(4,1fr)"></div>
  </div>
</section>
